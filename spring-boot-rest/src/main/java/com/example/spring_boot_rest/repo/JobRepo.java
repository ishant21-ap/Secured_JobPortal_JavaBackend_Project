...
//As we are not using Database we are adding data manually and storing it in List
//If in future we use database we only to change this class only
...
//
//
//    //Here we are updating all the values
...
//    }
    ...
    //Creating method for fetching data by searching a keyword
